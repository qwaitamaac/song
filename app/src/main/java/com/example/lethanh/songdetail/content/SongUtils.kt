package com.example.lethanh.songdetail.content
...
object SongUtils {
    ...
    val SONG_ID_KEY = "item_id"

    private val COUNT = 7

    class Song (val song_title: String, val details: String, var selected: Boolean)
    ...
    private fun createSongAtPosition(position: Int): Song {
        ...
        return Song(newTitle, newDetail, selector)
    }
}